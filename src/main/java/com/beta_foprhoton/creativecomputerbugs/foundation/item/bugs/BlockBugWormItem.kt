...
class BlockBugWormItem(properties: Properties) : AbstractBugItem(properties) {
    override fun useOn(context: UseOnContext): InteractionResult {
        ...
        CCBMain.BUG_COMPUTER_HOLDER_REGISTER.createWormComputerHolder(blockEntity, context.itemInHand.getUpgradeWithData(), family, context.clickedFace) ?: return super.useOn(context)
