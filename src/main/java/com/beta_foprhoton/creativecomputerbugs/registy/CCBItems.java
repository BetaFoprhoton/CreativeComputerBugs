...
import com.beta_foprhoton.creativecomputerbugs.foundation.item.bugs.BugWormItem;
...
public class CCBItems {
    ...
    public static final ItemEntry<BugWormItem> BUG_WORM = REGISTRATE
            .item("bug_worm", BugWormItem::new)
            .register();
